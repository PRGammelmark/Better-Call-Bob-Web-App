            ...
            <form action="" onSubmit={handleSubmit}>
                ...
                <div className={styles.inputLinesContainer}>
                    <div className={styles.inputLine}>
                        ...
                        <input className={styles.modalInput} type="number" value={brugerSatser.handymanTimerHonorar} onChange={(e) => {setBrugerSatser({...brugerSatser, handymanTimerHonorar: e.target.value}), setForudindstilletLøntrin(null)}}/>
                    </div>
                    <div className={styles.inputLine}>
                        <label className={styles.label} htmlFor="">Tømrertimer <br /><span className={styles.subLabel}>Kr./timen</span></label>
                        <input className={styles.modalInput} type="number" value={brugerSatser.tømrerTimerHonorar} onChange={(e) => {setBrugerSatser({...brugerSatser, tømrerTimerHonorar: e.target.value}), setForudindstilletLøntrin(null)}}/>
                    </div>
                    <div className={styles.inputLine}>
                        <label className={styles.label} htmlFor="">Rådgivning/opmåling <br /><span className={styles.subLabel}>Kr./timen</span></label>
                        <input className={styles.modalInput} type="number" value={brugerSatser.rådgivningOpmålingVejledningHonorar} onChange={(e) => {setBrugerSatser({...brugerSatser, rådgivningOpmålingVejledningHonorar: e.target.value}), setForudindstilletLøntrin(null)}}/>
                    </div>
                    <div className={styles.inputLine}>
                        <label className={styles.label} htmlFor="">Opstartsgebyr <br /><span className={styles.subLabel}>Kr./gang</span></label>
                        <input className={styles.modalInput} type="number" value={brugerSatser.opstartsgebyrHonorar} onChange={(e) => {setBrugerSatser({...brugerSatser, opstartsgebyrHonorar: e.target.value}), setForudindstilletLøntrin(null)}}/>
                    </div>
                    <div className={styles.inputLine}>
                        <label className={styles.label} htmlFor="">Aftentillæg <br /><span className={styles.subLabel}>Kr./timen</span></label>
                        <input className={styles.modalInput} type="number" value={brugerSatser.aftenTillægHonorar} onChange={(e) => {setBrugerSatser({...brugerSatser, aftenTillægHonorar: e.target.value}), setForudindstilletLøntrin(null)}}/>
                    </div>
                    <div className={styles.inputLine}>
                        <label className={styles.label} htmlFor="">Nattillæg <br /><span className={styles.subLabel}>Kr./timen</span></label>
                        <input className={styles.modalInput} type="number" value={brugerSatser.natTillægHonorar} onChange={(e) => {setBrugerSatser({...brugerSatser, natTillægHonorar: e.target.value}), setForudindstilletLøntrin(null)}}/>
                    </div>
                    <div className={styles.inputLine}>
                        <label className={styles.label} htmlFor="">Trailer <br /><span className={styles.subLabel}>Kr./gang</span></label>
                        <input className={styles.modalInput} type="number" value={brugerSatser.trailerHonorar} onChange={(e) => {setBrugerSatser({...brugerSatser, trailerHonorar: e.target.value}), setForudindstilletLøntrin(null)}}/>
                    </div>
                </div>
