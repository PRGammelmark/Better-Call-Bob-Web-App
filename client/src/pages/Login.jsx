  ...
  return (
    <div className={styles.loginContainer}>
      <form action="" className={styles.loginForm} onSubmit={handleSubmit} autoComplete="on">
        ...
        <input className={styles.input} type="email" name="email" autoComplete="email" onTouchEnd={(e) => e.preventDefault()} onFocus={(e) => e.target.focus()} onChange={(e) => setEmail(e.target.value)} value={email} />
